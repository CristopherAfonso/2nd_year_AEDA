 ...
 * 
 * @file StateAlive2.h 
 * @brief Donde se aloja la declaración de la clase StateAlive2 y la declaracion
 * de sus metodos. La clase StateAlive2 es una clase de 2 clases de las cuales
...
#ifndef _STATEALIVE2_
#define _STATEALIVE2_
...
class StateAlive2 : public State {
 public:
